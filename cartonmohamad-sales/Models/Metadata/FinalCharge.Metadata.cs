...
namespace cartonmohamad_sales.Models
{
    ...
    public sealed class FinalChargeMeta
    {
        [Key] public int final_charge_id { get; set; }
        ...
        [Display(Name = "فعال؟")] public bool is_active { get; set; }
        [Display(Name = "اجباری؟")] public bool is_required { get; set; }
        ...
        [Display(Name = "نرخ درصدی")] public decimal? percent_rate { get; set; }
